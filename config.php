...
define("DB_DSN","dblib:host=......;dbname=xxxxx");
define("DB_DSN1","dblib:host=1xxxx;dbname=xxxxx");
...
define("SQL_MODIFICA_PIOBIN","UPDATE " . TBL_FICHA . " SET TIEMPO=:TIEMPO,FECHA=:FECHA,   
